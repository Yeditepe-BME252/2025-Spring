...
- The resultant force on $\Omega$ due to body and surface forces is
  $$ \boldsymbol{r}[\Omega] = \boldsymbol{r}_b[\Omega] + \boldsymbol{r}_s[\partial\Omega] = \int_\Omega \rho\,dV+ \int_{\partial\Omega} dA $$
- The resultant torque on $\Omega$, about point $\boldsymbol{z}$, due to body and surface forces is
  $$ \boldsymbol{\tau}[\Omega] = \boldsymbol{\tau}_b[\Omega] + \boldsymbol{\tau}_s[\partial\Omega] = \int_\Omega \rho\,dV+ \int_{\partial\Omega} dA $$

...
- It is implied that $\bar{\boldsymbol{t}}$ over the boundary is equilibrated by the internal traction $\boldsymbol{t} = \boldsymbol{\sigma} \cdot \boldsymbol{n}$.
- Substituting the internal tractions into the second term, the *linear equilibrium equation* becomes
  $$ \int_\mathcal{B} \boldsymbol{b}\, \rho\,dV + \int_{\partial\mathcal{B}} \boldsymbol{\sigma} \cdot \boldsymbol{n} \, dA = \boldsymbol{0}. $$
